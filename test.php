...
function display_block( $file )
{
	...
	$rtn = "<div class=\"block\" data-toggle=\"modal\">";


	//$rtn .= "		<img src=\"$file\" alt=\"$file\" id=\"$file\" class=\"thumbnail\">";
	...
	else
	{
		...
		if(@is_array(getimagesize($file))){
			$rtn .= "	<div class=\"img $file_ext marek\" id=\"$file\"></div>";
			$rtn .= "	<div class=\"name\">";
			//$rtn .= "		<div id=\"$file\" class=\"thumbnail\">asd</div>";
			$rtn .= "			<div class=\"file fs-1-2 bold\" >" . basename($file) . "</div>";
